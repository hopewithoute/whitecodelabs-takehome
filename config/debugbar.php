...
return [
    ...
    */
    ...
    'options' => [
        ...
        'memory' => [
            ...
            'precision' => intval(env('DEBUGBAR_OPTIONS_MEMORY_PRECISION', 0)),       // Memory rounding precision
        ],
        'auth' => [
        ...
        'db' => [
            ...
            'soft_limit' => intval(env('DEBUGBAR_OPTIONS_DB_SOFT_LIMIT', 100)),  // After the soft limit, no parameters/backtrace are captured
            'hard_limit' => intval(env('DEBUGBAR_OPTIONS_DB_HARD_LIMIT', 500)),  // After the hard limit, queries are ignored
        ],
        'mail' => [
        ...
        'views' => [
            ...
            'group' => intval(env('DEBUGBAR_OPTIONS_VIEWS_GROUP', 50)),                    // Group duplicate views. Pass value to auto-group, or true/false to force
    ...
    */
     ...
     */
    'debug_backtrace_limit' => intval(env('DEBUGBAR_DEBUG_BACKTRACE_LIMIT', 50)),
];
